...
Reports generated by this framework can be viewed directly in any web browser:

1. **Open Locally**: Double-click the `index.html` file or open it in your browser
   - Reports now have embedded data and work without CORS issues
   - No web server needed!

2. **Fix Downloaded Reports** (for older reports with CORS errors):
   ```bash
   python fix_downloaded_reports.py ~/Downloads/artifact/report_20251115_135705_llama3.2/
   ```

3. **Alternative - Use a Web Server**:
   ```bash
   cd AI_Reports/report_20251115_003411_granite3.1-dense_2b/
   python3 -m http.server 8000
   # Open http://localhost:8000/index.html
   ```

> **Note**: If you encounter "CORS policy" errors with older downloaded reports, see the [TROUBLESHOOTING guide](.github/TROUBLESHOOTING.md#cors-error-when-viewing-downloaded-reports) for solutions.
